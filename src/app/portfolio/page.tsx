        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              across Africa achieve their digital goals through innovative solutions.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          >
              ...
              <Card className="h-full">
                <CardContent className="p-6">
                  <p className="text-gray-600 mb-4">
                    "Aurora Software Labs transformed our fashion brand's online presence. 
                    The e-commerce platform they built has significantly increased our sales 
            ...
            <motion.div variants={fadeInUp}>
              <Card className="h-full">
                <CardContent className="p-6">
                  <p className="text-gray-600 mb-4">
                    "The campaign website was instrumental in our success. It perfectly 
                    captured our message and helped us connect with voters across campus. 
                    Highly recommended!"
                  </p>
                  <div className="border-t pt-4">
                    <p className="font-semibold">Michael Yeng</p>
                    <p className="text-sm text-gray-500">Former SRC Candidate</p>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="h-full">
                <CardContent className="p-6">
                  <p className="text-gray-600 mb-4">
                    "Working with Aurora was a game-changer for our multi-vendor platform. 
                    They understood our complex requirements and delivered a solution that 
                    exceeded our expectations."
                  </p>
                  <div className="border-t pt-4">
                    <p className="font-semibold">David Osei</p>
                    <p className="text-sm text-gray-500">Founder, Lolyraced Ventures</p>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
